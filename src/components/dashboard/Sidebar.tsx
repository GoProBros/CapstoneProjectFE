              ...
              >
                <button
                  ...
                  className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-colors ${
                    theme === "dark"
                      ? "border-white-500 hover:border-white-400"
              ...
              <div className="relative w-8 flex flex-col items-center">
                ...
                <input
                  ...
                  style={{
                    background:
                      theme === "dark"
                        ? `linear-gradient(to top, rgba(107, 114, 128, 0.4) ${
                            fontSize * 10
                          }%, #1a1a1a ${fontSize * 10}%)`
                        : `linear-gradient(to top, rgba(156, 163, 175, 0.5) ${
                            fontSize * 10
                          }%, #e5e7eb ${fontSize * 10}%)`,
                  }}
                  type="range"
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[10001]">
          <div className="bg-white dark:bg-[#1e1e2e] rounded-lg p-6 max-w-sm w-full mx-4 shadow-xl border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
              Bạn có chắc chắn muốn xóa page{" "}
              <strong>
                “{pages.find((p) => p.id === pageToDelete)?.name}”
              </strong>
              ? Tất cả modules trong page này sẽ bị xóa.
            </p>
