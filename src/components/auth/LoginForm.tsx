  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Custom Google Button — CourtSync input style */}
        <div className="group relative w-full h-11">
          <div className="absolute inset-0 flex items-center justify-center gap-3 rounded-xl bg-slate-800/50 border-2 border-slate-700/50 group-hover:bg-slate-800/70 group-hover:border-slate-600/50 text-white text-sm font-medium transition-all duration-300 pointer-events-none select-none">
          ...
          <div className="absolute inset-0 opacity-0 cursor-pointer">
            <GoogleLogin onSuccess={handleGoogleLoginSuccess} onError={() => setError('Đăng nhập Google thất bại. Vui lòng thử lại.')} width="500" />
          </div>
        </div>
