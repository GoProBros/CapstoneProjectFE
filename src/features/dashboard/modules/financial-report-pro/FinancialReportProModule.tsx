...
import { SaveLayoutModal } from '@/features/dashboard/components/layout';
import { useDashboard } from '@/contexts/DashboardContext';
import { useModule } from '@/contexts/ModuleContext';
import { useFinancialReportQuery } from './useFinancialReportQuery';
...
export function FinancialReportProModule() {
  return (
